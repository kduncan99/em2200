...
${OBJECTDIR}/PersistableNodeTable.o: nbproject/Makefile-${CND_CONF}.mk PersistableNodeTable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersistableNodeTable.o PersistableNodeTable.cpp

${OBJECTDIR}/SSPConsole.o: nbproject/Makefile-${CND_CONF}.mk SSPConsole.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SSPConsole.o SSPConsole.cpp

${OBJECTDIR}/SSPPanel.o: nbproject/Makefile-${CND_CONF}.mk SSPPanel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SSPPanel.o SSPPanel.cpp

${OBJECTDIR}/SubSystem.o: nbproject/Makefile-${CND_CONF}.mk SubSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SubSystem.o SubSystem.cpp
