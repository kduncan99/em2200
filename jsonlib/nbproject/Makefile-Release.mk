...
${OBJECTDIR}/JSONArrayValue.o: nbproject/Makefile-${CND_CONF}.mk JSONArrayValue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JSONArrayValue.o JSONArrayValue.cpp

${OBJECTDIR}/JSONBooleanValue.o: nbproject/Makefile-${CND_CONF}.mk JSONBooleanValue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JSONBooleanValue.o JSONBooleanValue.cpp

${OBJECTDIR}/JSONNullValue.o: nbproject/Makefile-${CND_CONF}.mk JSONNullValue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JSONNullValue.o JSONNullValue.cpp

${OBJECTDIR}/JSONNumberValue.o: nbproject/Makefile-${CND_CONF}.mk JSONNumberValue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JSONNumberValue.o JSONNumberValue.cpp

${OBJECTDIR}/JSONObjectValue.o: nbproject/Makefile-${CND_CONF}.mk JSONObjectValue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JSONObjectValue.o JSONObjectValue.cpp
...
${OBJECTDIR}/JSONStringValue.o: nbproject/Makefile-${CND_CONF}.mk JSONStringValue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JSONStringValue.o JSONStringValue.cpp

${OBJECTDIR}/JSONValue.o: nbproject/Makefile-${CND_CONF}.mk JSONValue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JSONValue.o JSONValue.cpp
